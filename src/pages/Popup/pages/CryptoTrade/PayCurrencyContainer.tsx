    ...
    return (
        <div className="flex flex-col items-start justify-center gap-2 w-80 p-2 bg-[#262632] rounded-md">
            ...
            <div className="flex justify-between items-center w-full">
                <TokenContainer
                    tokenName={tradeInfo.payTokenName}
                    onClickHandler={selectPayCurrency}
                />

                <input
                    type="number"
                    value={tradeInfo.payTokenAmount ? tradeInfo.payTokenAmount : 0}
                    dir="rtl"
